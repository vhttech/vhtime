...
func (e *Engine) emojiProcessKeyEvent(keyVal uint32, keyCode uint32, state uint32) bool {
...
func (e *Engine) updateCursorPosInEmojiTable(idx uint32) bool {
...
func (e *Engine) updateEmojiLookupTable() {
...
func (e *Engine) closeEmojiCandidates() {
